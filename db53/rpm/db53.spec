...
rm -f ${RPM_BUILD_ROOT}%{_libdir}/libdb-5.so
rm -f ${RPM_BUILD_ROOT}%{_libdir}/libdb_cxx.so
rm -f ${RPM_BUILD_ROOT}%{_libdir}/libdb_cxx-5.so
rm -f ${RPM_BUILD_ROOT}%{_libdir}/libdb_tcl-5.so
...
rm -f ${RPM_BUILD_ROOT}%{_libdir}/libdb_java-5.so ${RPM_BUILD_ROOT}%{_libdir}/libdb_java.so
%endif
...
chmod -R u+w ${RPM_BUILD_ROOT}%{_bindir}
